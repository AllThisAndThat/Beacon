...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(Noodle_GPIO_Port, Noodle_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : Noodle_Pin */
  GPIO_InitStruct.Pin = Noodle_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Noodle_GPIO_Port, &GPIO_InitStruct);
...
void Error_Handler(void)
{
  ...
  HAL_GPIO_WritePin(Noodle_GPIO_Port, Noodle_Pin, GPIO_PIN_SET);
  while (1)
  {
  }
